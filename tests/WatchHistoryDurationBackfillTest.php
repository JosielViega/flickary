...
final class DurationCatalog implements TmdbCatalog
{
    ...
    public function seriesDetails(int$id):TmdbMediaDetails{throw new \LogicException();}public function configuration():TmdbImageConfiguration{throw new \LogicException();}public function searchMovies(string$q,int$p=1):array{return[];}public function searchSeries(string$q,int$p=1):array{return[];}public function discoverAnimeMovies(int$p=1):array{return[];}public function discoverAnimeSeries(int$p=1):array{return[];}
}
