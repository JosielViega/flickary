...
final class WatchHistoryControllerTest extends TestCase
{
    ...
    public function testIndexIsOfflineUsefulFiltersPaginatesAndEscapesSnapshots(): void
    {
        ...
        $store->entries[] = new WatchHistoryEntry(1, 7, 'tmdb', 'episode', 1396, 1, 1, '<script>alert(1)</script>', '<b>x</b>', '<img src=x>', '2008-01-20', '/poster.jpg', date('Y-m-d'), '2026-09-18 10:00:00', '2026-09-18 10:00:00');
        $catalog->fail = true;
    ...
    {
        return new WatchHistoryEntry($id, $userId, 'tmdb', 'movie', 603, null, null, 'Matrix', 'The Matrix', null, '1999-03-31', '/matrix.jpg', date('Y-m-d'), '2026-09-18 10:00:00', '2026-09-18 10:00:00');
    }
}
...
final class WatchHistoryCatalog implements TmdbCatalog
{
    ...
    public function seasonDetails(int $seriesId, int $seasonNumber): TmdbSeasonDetails { $this->calls[]=['season',$seriesId,$seasonNumber];$this->guard();return new TmdbSeasonDetails('tmdb',$seriesId,1,$seasonNumber,'Temporada 1','Resumo','2008-01-20',null,[new TmdbEpisode(1,$seasonNumber,1,'Piloto','Resumo','2008-01-20',58,null)]); }
